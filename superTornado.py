...
class MainHandler(BaseHandler):
    ...
    def post(self):
        ...
        if autorise == True:
            ficLog.enregDansLog(iden,"Authorized user connection",repr(self.request.remote_ip()))
            if confAveug == True:
...
class UnauthorizedHandler(BaseHandler):
    ...
    def post(self):
        ...
        if force == "1" :
            ...
            ficLog.enregDansLog("illegalUser","Unauthorized user connection",repr(self.request.remote_ip()))
            if confAveug == True:
